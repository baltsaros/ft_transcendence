		...
		<div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-opacity-50 bg-black z-50">
			<div className="bg-gray-400 p-8 rounded-lg shadow-lg flex flex-col">
				...
				<div className="mb-4">
					...
					<select id="channelMode" className="w-full mt-1 p-2 border rounded text-gray-800 focus:outline-none focus:border-blue-500" onChange={handleChannelMode} value={channelMode}>
